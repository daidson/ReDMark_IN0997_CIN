############
# SOURCE: https://github.com/DHZS/tf-deformable-conv-layer
# AUTHOR: An Jiaoyang
# DATE: 2018-10-11
############
...
class DeformableConvLayer(Conv2D):
    ...
    def call(self, inputs, training=None, **kwargs):
        ...
        y, x = self._get_conv_indexes([in_h, in_w])
        ...
        y0, x0 = [tf.cast(tf.math.floor(i), tf.int32) for i in [y, x]]
        y1, x1 = y0 + 1, x0 + 1
        # clip
        ...
        p0, p1, p2, p3 = [DeformableConvLayer._get_pixel_values_at_point(inputs, i) for i in indexes]
    ...
    def _get_conv_indexes(self, feature_map_size):
    ...
    @staticmethod
    def _get_pixel_values_at_point(inputs, indexes):
        """get pixel values

        :param inputs:
        :param indexes: shape [batch_size, H, W, I], I = filter_h * filter_w * channel_out
        :return:
        """
        y, x = indexes
